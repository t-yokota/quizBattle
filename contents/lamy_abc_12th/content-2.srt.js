...
myApp.val.firstQuesStartTime = 19.22;
myApp.val.srtFuncArray = [
    function(){
        ...
        myApp.val.ansIndexStartTime = 30.26;
        //
        myApp.val.status = myApp.state.Question;
        myApp.val.numQues = 1;
        myApp.val.cntPush = 0;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 46.69;
        //
        myApp.val.status = myApp.state.Question;
        myApp.val.numQues = 2;
        myApp.val.cntPush = 0;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 61.83;
        //
        myApp.val.status = myApp.state.Question;
        myApp.val.numQues = 3;
        myApp.val.cntPush = 0;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 77.83;
        //
        myApp.val.status = myApp.state.Question;
        myApp.val.numQues = 4;
        myApp.val.cntPush = 0;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 93.07;
        //
        myApp.val.status = myApp.state.Question;
        myApp.val.numQues = 5;
        myApp.val.cntPush = 0;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 104.11;
        //
        myApp.val.status = myApp.state.Question;
        myApp.val.numQues = 6;
        myApp.val.cntPush = 0;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 120.2;
        //
        myApp.val.status = myApp.state.Question;
        myApp.val.numQues = 7;
        myApp.val.cntPush = 0;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 136.73;
        //
        myApp.val.status = myApp.state.Question;
        myApp.val.numQues = 8;
        myApp.val.cntPush = 0;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 152.22;
        //
        myApp.val.status = myApp.state.Question;
        myApp.val.numQues = 9;
        myApp.val.cntPush = 0;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 166.8;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 180.54;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 195.26;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 211.41;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 226.77;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 241.76;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 257.99;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 274.94;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 290.35;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 302.48;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 317.07;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 333.88;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 349.54;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 365.93;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 381.07;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 394.07;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 408.43;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 424.86;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 437.53;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 453.19;
        //
        myApp.val.status = myApp.state.Question;
    ...
    function(){
        ...
        myApp.val.ansIndexStartTime = 468.93;
        //
        myApp.val.status = myApp.state.Question;
