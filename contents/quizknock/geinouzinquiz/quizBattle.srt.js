...
const myApp = {
    path : {
        answer : "https://raw.githubusercontent.com/t-yokota/quizBattle/master/contents/quizknock/geinouzinquiz/answer.csv",
...
function myIntervalEvent(){
    if(myApp.val.pageHiddenBool == false){
        if(player.getPlayerState() == myApp.videoState.Playing){
            myApp.val.currTime.playing = player.getCurrentTime();
            myApp.val.watchedTime = updateWatchedTime(myApp.val.currTime.playing, myApp.val.watchedTime);
            if(myApp.val.playingCount < 10){ myApp.val.playingCount += 1; myApp.val.watchedTime = myApp.val.currTime.playing; }
...
1
00:01:51,090 --> 00:01:56,060


2
00:01:56,060 --> 00:02:39,940
...
8
00:04:16,760 --> 00:04:45,330


9
00:04:45,330 --> 00:04:51,200


10
00:04:51,200 --> 00:05:30,730


11
00:05:30,730 --> 00:05:39,560


12
00:05:39,560 --> 00:06:29,380
...
14
00:06:35,230 --> 00:07:28,470


15
00:07:28,470 --> 00:07:32,960


16
00:07:32,960 --> 00:08:36,800
