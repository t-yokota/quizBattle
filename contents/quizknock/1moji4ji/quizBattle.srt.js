...
function resizePushButton(){
    if(myApp.val.os != "other"){
        if(Math.abs(window.orientation) != 90){
            ...
            const tmpImgHeight = document.documentElement.clientHeight-parseInt(myApp.elem.text.style.lineHeight, 10)-parseInt(myApp.elem.ansCol.style.height, 10)-parseInt(myApp.elem.ansBtn.style.height, 10)-parseInt(myApp.elem.numOX.style.lineHeight, 10);
