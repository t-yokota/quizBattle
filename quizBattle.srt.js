...
function printParams(){
    myApp.elem.text.innerHTML = "sounds.currentTime: " + myApp.elem.sounds.currentTime + " / " + myApp.val.spriteData.pushBtn.end + " / " + myApp.val.spriteData.sndO.end + " / " + myApp.val.spriteData.sndX.end;
